...
class Visualize:
    ...
    '''
    def __init__(self,mid,output_path):
        ...
        ## get word2vec
        result = self.collection.find({"_id": self.oid}, {"_id": False, "word2vec": True})

        #저장된 모델 load
        model = Word2Vec.load(result[0]['word2vec'])
        # tensorboard 저장 형식
...
if __name__ == '__main__' :
    ...
    visualize = Visualize("https://s3.ap-northeast-2.amazonaws.com/tensorpath/test_word2vec.model","./test")
    # 텐서보드 실행
